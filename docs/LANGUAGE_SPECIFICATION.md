...
fn main() {
    var my_tensor: Tensor = Tensor.random([100]);
...
fn main() {
    var my_tensor: Tensor = Tensor.zeros([1024]);
...
fn main() {
    ...
    var image_tensor: Tensor = load_image("image.jpg");
...
fn main() {
    ...
    var states: Tensor @sharded(cluster, 0) = Tensor.zeros([4096, 1024]);
